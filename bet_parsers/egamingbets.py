...
#		print(recognize_discipline(bet_jsoned['game']), bet_jsoned['game'])
		result['discipline'] = self.recognize_discipline(bet_jsoned['game'])
		...
		result['league_id'] = bet_jsoned['tourn'].strip()
